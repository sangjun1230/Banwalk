		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
                ...
                <img class="img-profile rounded-circle" src="https://source.unsplash.com/QAB-WJcbgJk/60x60"> -->
						...
						<li class="nav-item"><a class="nav-link"
							style="color: black;" href="logout.do"> 로그 아웃
						</a></li>
			...
			<tr>
				...
				<td>
					<!-- aaa데이터 타입을 사용하는 방법 --> 
						...
						<fmt:parseDate var = "b_regdate" value="${row.regdate}" pattern="yyyy-MM-dd HH:mm:ss"/>
						<fmt:formatDate value="${b_regdate}" pattern="yyyy/MM/dd HH:mm:ss"/>
				</td>
				<td>${row.viewcount}</td>
			</tr>
		</c:forEach>
