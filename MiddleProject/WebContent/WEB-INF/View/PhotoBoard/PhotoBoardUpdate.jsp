...
<body id="page-top">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="board.do">게시판</a>
 ...
 %>
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <a class="dropdown-item" href="memberUpdate.html">
                  <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                  프로필
                </a>
                <a class="dropdown-item" href="petUpdate.html">
  ...
  <div class="container">
    <div class="row">
		<form action="<%=root %>/updatecontent.do" method="POST">
 		<br><br>
			글번호 : <input type="text" name="no" value="${vo.no}" readonly="readonly"><br>
			제 목 : <input type="text" name="title" value="${vo.title}" /><br>
			작성자 : <input type="text" name="n_id" value="${vo.n_id}" readonly="readonly"><br>
			내 용 : <input type="text" name="contents" value="${vo.contents}" /><br>
